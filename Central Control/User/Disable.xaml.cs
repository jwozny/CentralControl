...
namespace Central_Control.User
{
    /// <summary>
    ...
    public partial class Disable : Page
    {
        ...
        private void disableLabelButton_MouseDown(object sender, RoutedEventArgs e)
        {
            ...
            if (confirmAction)
            {
                ...
                confirmMessage.Content = "Are you sure you want to disable " + ActiveDirectory.SelectedUser.SamAccountName + "?";
                confirmYesLabelButton.Content = "Disable " + ActiveDirectory.SelectedUser.SamAccountName;
            ...
            {
                if (ActiveDirectory.SelectedUser.DisableUser())
                {
