...
namespace Unified_Systems.User
{
    ...
    public partial class User : Page
    {
        ...
        public User()
        {
            ...
            ActiveDirectory.SaveUser.RunWorkerCompleted += this.SaveUser_Completed;
            ...
            foreach (PSObject User in ActiveDirectory.Users)
            {
                if (userList.SelectedItem != null)
                {
                    if (User.Properties["SamAccountName"].Value.ToString() == userList.SelectedItem.ToString())
                    {
                        ...
                        //memberOfGrid.ItemsSource = User.Properties["MemberOf"];
                    }
                }
                else
                {
        ...
        private void saveLabelButton_MouseDown(object sender, RoutedEventArgs e)
        {
            ...
            {
                if (!ActiveDirectory.SaveUser.IsBusy)
                {
                    ActiveDirectory.SaveUser.RunWorkerAsync();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void SaveUser_Completed(object sender, RunWorkerCompletedEventArgs e)
        {
            if (ActiveDirectory.SaveUserResults == null)
            {
